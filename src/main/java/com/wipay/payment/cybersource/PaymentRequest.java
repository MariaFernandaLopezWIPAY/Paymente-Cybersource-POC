...
public class PaymentRequest {
    ...
    public PtsV2PaymentsPost201Response processPayment(PaymentDTO paymentDTO) {

        CreatePaymentRequest requestObj = new CreatePaymentRequest();
        PtsV2PaymentsPost201Response result = null;
        try {
            Ptsv2paymentsClientReferenceInformation clientReferenceInformation = new Ptsv2paymentsClientReferenceInformation();
            clientReferenceInformation.code(paymentDTO.getClientReferenceInformation().getCode());
            requestObj.clientReferenceInformation(clientReferenceInformation);
            ...
            Ptsv2paymentsPaymentInformation paymentInformation = new Ptsv2paymentsPaymentInformation();
            Ptsv2paymentsPaymentInformationCard paymentInformationCard = new Ptsv2paymentsPaymentInformationCard();
            paymentInformationCard.number(paymentDTO.getPaymentInformation().getPaymentInformationCard().getNumber());
            ...
            Ptsv2paymentsOrderInformation orderInformation = new Ptsv2paymentsOrderInformation();
            Ptsv2paymentsOrderInformationAmountDetails orderInformationAmountDetails = new Ptsv2paymentsOrderInformationAmountDetails();
            orderInformationAmountDetails.totalAmount(paymentDTO.getOrderInformation().getOrderInformationAmountDetails().getTotalAmount());
            orderInformation.amountDetails(orderInformationAmountDetails);

            Ptsv2paymentsOrderInformationBillTo orderInformationBillTo = new Ptsv2paymentsOrderInformationBillTo();
            orderInformationBillTo.firstName(paymentDTO.getOrderInformationBillTo().getFirstName());
            orderInformation.billTo(orderInformationBillTo);
